...
$datosNuevaTarjAdic = $nuevaTarj->generarInfoAdicionalTarjetaCredito();
$d0 = $datosNuevaTarj[0];
$d1 = $datosNuevaTarj[1];
$d2 = $datosNuevaTarj[2];
$d3 = $datosNuevaTarj[3];
$d4 = $datosNuevaTarjAdic[0];
$d5 = $datosNuevaTarjAdic[1];
$comis = 79;
							...
							<nav class="navbar">
								<div class="collapse navbar-collapse">
									<ul class="nav menu navbar-nav">
                                        <li class="current"><a href="#header">Creación de tarjeta de crédito</a></li>
        ...
        <div class="row">
          <div class="col-sm-12">
             <div class="jumbotron">  
                 ...
                 <br>
                 <h2>Unicamente debe proporcionar el monto de la linea de credito y el domicilio de facturacion de la tarjeta</h2>
                 <br>
                 <section>
                  ...
                  <br><br>
                 <section>
                 <h1>Ingrese su domicilio de facturación para la tarjeta</h2>
                 <br>
                 <form action="anadirTC.php" method="post">
                     <?php
                     ...
                     <br>
                     <h2>Elige un monto de credito:</h2>
                     <br>
                     <select name="lineaCred" required>
                         <option value="3000">$ 3,000 MXN</option>
                         <option value="6000">$ 6,000 MXN</option>
                         <option value="10000">$ 10,000 MXN</option>
                         <option value="16000">$ 16,000 MXN</option>
                      </select>
                      <br><br>
                     <button type="submit" class="btn btn-info">Crear tarjeta de crédito</button>
                  </form>
             </div>
          </div>
        </div>
